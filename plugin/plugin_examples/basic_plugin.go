...
// be found at  "github.com/LukasHeimann/cloudfoundrycli/v8/plugin/plugin.go"
...
func main() {
	...
	// implementing the interface defined at "github.com/LukasHeimann/cloudfoundrycli/v8/plugin/plugin.go"
	//
