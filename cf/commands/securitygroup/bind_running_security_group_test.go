...
import (
	...
	"github.com/LukasHeimann/cloudfoundrycli/v8/cf/api/securitygroups/defaults/running/runningfakes"
	"github.com/LukasHeimann/cloudfoundrycli/v8/cf/api/securitygroups/securitygroupsfakes"
